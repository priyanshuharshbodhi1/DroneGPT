...
- `5-tello_real_drone.ipynb`: real drone fly
...
- `tello_agent.py`:Encapsulation of IO Intelligence large model service,for tello drone (please fill in your own API key)
- `tello_wrapper.py`: Encapsulation of tello edu drone, optimized for LLM calls
...
**Scene 4:**  
<img src="img/s4.png" alt="IO.AIRGPT Framework" width="600">
